#!/usr/bin/env python3
"""
Standalone script to run scikit-fem cylinder flow simulations.

This script provides a command-line interface for running cylinder flow
simulations using the scikit-fem library implementation.
"""
...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(
        description="Run scikit-fem cylinder flow simulation",
    ...
    # Output parameters
    parser.add_argument("--output-dir", "-o", default="results/skfem",
...
def run_simulation(args):
    ...
    print("=" * 60)
    print("Scikit-fem Cylinder Flow Simulation")
    print("=" * 60)
    ...
    # Save results
    print(f"\nSaving results...")
    output_filename = f"{args.output_dir}/skfem_{args.condition}_flow.npz"
    simulation.save_results(results, output_filename)

    # Generate visualization if requested
    if args.visualize:
        print(f"\nGenerating visualizations...")
        viz_filename = f"{args.output_dir}/skfem_{args.condition}_solution.png"
...
def run_all_conditions():
    ...
    for condition in conditions:
        ...
        # Save results
        output_filename = f"results/skfem/skfem_{condition}_flow.npz"
        simulation.save_results(results, output_filename)
