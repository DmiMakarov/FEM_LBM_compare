#!/usr/bin/env python3
"""
Standalone script to run FEniCS cylinder flow simulations.

This script provides a command-line interface for running cylinder flow
simulations using the FEniCS library implementation.
"""
...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(
        description="Run FEniCS cylinder flow simulation",
    ...
    # Output parameters
    parser.add_argument("--output-dir", "-o", default="results/fenics",
...
def run_simulation(args):
    ...
    print("=" * 60)
    print("FEniCS Cylinder Flow Simulation")
    print("=" * 60)
    ...
    # Save results
    print(f"\nSaving results...")
    output_filename = f"{args.output_dir}/fenics_{args.condition}_flow.npz"
    simulation.save_results(results, output_filename)

    # Generate visualization if requested
    if args.visualize:
        print(f"\nGenerating visualizations...")
        viz_filename = f"{args.output_dir}/fenics_{args.condition}_solution.png"
...
def run_all_conditions():
    ...
    for condition in conditions:
        ...
        # Save results
        output_filename = f"results/fenics/fenics_{condition}_flow.npz"
        simulation.save_results(results, output_filename)
